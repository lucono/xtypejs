...
(function(window, global) {
    ...
    var appArtifacts = {
        /* --- Screens --- */
        overview: {
            template: '/site/screens/overview/overviewScreen.html',
            code: 'site/screens/overview/overviewCodeSamples.html'
        },
        guide: {
            template: '/site/screens/guide/guideScreen.html',
            code: 'site/screens/guide/guideCodeSamples.html'
        },
        types: {
            template: '/site/screens/types/typesScreen.html',
            code: 'site/screens/types/typeCodeSamples.html',
            json: 'site/screens/types/types.json'
        },
        api: {
            template: '/site/screens/api/apiScreen.html',
            code: 'site/screens/api/apiCodeSamples.html',
            json: 'site/screens/api/api.json'
        },
        play: {
            template: '/site/screens/play/playScreen.html',
            code: 'site/screens/play/playCodeSamples.html'
        },
        getit: {
            template: '/site/screens/getit/getitScreen.html',
            code: 'site/screens/getit/getitOptions.html',
            json: 'https://api.github.com/repos/lucono/xtypejs/releases/latest'
        },
        /* --- Components --- */
        codeSnippet: {
            template: '/site/components/code-snippet/code-snippet.tpl.html'
        }
    };
