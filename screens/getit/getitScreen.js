        ...
        $scope.extensions = [
            {
                ...
                url: 'https://www.npmjs.com/package/xtypejs-extension-custom-types'
            },
            {
                ...
                url: 'https://www.npmjs.com/package/xtypejs-extension-typename-utils'
            },
            {
                ...
                url: 'https://www.npmjs.com/package/xtypejs-extension-autocamel-name-scheme'
            }
        ];
        ...
        $scope.nameSchemes = [
            {
                ...
                url: 'https://www.npmjs.com/package/xtypejs-name-scheme-compact'
            },
            {
                name: 'xtypejs-name-scheme-camel',
                description: 'Provides a camel-cased name scheme for the xtypejs built-in types.',
                url: 'https://www.npmjs.com/package/xtypejs-name-scheme-camel'
            },
            {
                ...
                url: 'https://www.npmjs.com/package/xtypejs-name-scheme-shortened'
            },
            {
                ...
                url: 'https://www.npmjs.com/package/xtypejs-name-scheme-shortened-camel'
            }
        ];
