module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    karma: {
      ...
      source_lib: {
        files: [
          { src: ['build/shared/test/test-util.js', 'build/shared/xtype.js', 'dist/xtypejs-extension-custom-types.js', 'test/**/*-spec.js'] }
        ],
      ...
      minified_lib: {
        ...
        htmlReporter: {
          ...
          focusOnFailures: true,
          namedFiles: true,
          pageTitle: 'xtypejs-extension-custom-types - Minified Lib Test Report',
          urlFriendlyName: true,
          preserveDescribeNesting: true,
          foldAll: true
        }
