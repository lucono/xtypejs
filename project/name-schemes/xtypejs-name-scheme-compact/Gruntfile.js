module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    karma: {
      ...
      source_lib: {
        ...
        htmlReporter: {
          ...
          namedFiles: true,
          pageTitle: 'xtypejs-name-scheme-compact - Source Lib Test Report',
        ...
        preprocessors: {
          'dist/xtypejs-name-scheme-compact.js': ['coverage']
        }
      }
    },
    uglify: {
      ...
      main: {
        options: {
          sourceMap: true,
          sourceMapName: 'dist/xtypejs-name-scheme-compact.js.map',
          preserveComments: 'some'
        },
        files: {
          'dist/xtypejs-name-scheme-compact.min.js': ['dist/xtypejs-name-scheme-compact.js']
        }
      }
    },
    copy: {
      main: {
        files: [
          ...
          {
            expand: true,
            src: ['xtypejs-name-scheme-compact.js'],
            flatten: true,
            dest: 'dist/',
            filter: 'isFile'
          }
    ...
    shell: {
      jasmine_node_test: {
        command: './node_modules/jasmine/bin/jasmine.js test/xtypejs-name-scheme-compact-spec.js JASMINE_CONFIG_PATH=test/jasmine.json'
      }
    },
    'string-replace': {
      version: {
        files: {
          'dist/': ['dist/xtypejs-name-scheme-compact.js']
        },
        options: {
          replacements: [
            {
